namespace TennisWebsite.ClassLibrary.Helpers
{
    public class DLStringComparer<T>
    {
        ...
        public static List<DLStringScoreObject<T>> Matches(List<T> matchables, Func<T, string> selector, string query, bool ascending)
        ...
        public static List<DLStringScoreObject<T>> Matches(List<T> matchables, Func<T, string> selector, string query)
        //Example selector x => x.Username, if it is a user
        {
