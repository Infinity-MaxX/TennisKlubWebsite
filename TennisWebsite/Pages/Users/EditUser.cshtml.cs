...
namespace TennisWebsite.Pages.Users
{
    public class EditUserModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string Username, bool KeepImage)
        {
            ...
            if(tempUser != null)
            {
                ...
                if (!KeepImage) OldImageName = Defaults.DefaultImage;
                return Page();
            }
        ...
        {
            if (OldImageName == null) OldImageName = Defaults.DefaultImage;
